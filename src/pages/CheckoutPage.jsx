...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Sim. Caso precise de ajuda, nosso suporte é feito por e-mail: contato@digitalstoregames.com'
  },
  {
...
export function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-[#f8fafc] font-['Montserrat'] antialiased pb-20 select-none">
          ...
          <section className="bg-[#1e293b] border border-[#334155] rounded-[14px] p-4 md:p-6 shadow-xl">
            ...
            <form onSubmit={e => e.preventDefault()} className="space-y-4" noValidate>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <span className="text-gray-500 text-[10px] md:text-xs">Usado para rastreamento da entrega.</span>
              </div>
      ...
      {/* Floating help WhatsApp Button - DESATIVADO TEMPORARIAMENTE - problema com WhatsApp Business */}
      {/* <a 
