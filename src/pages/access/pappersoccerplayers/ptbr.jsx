        ...
        <div className="w-full max-w-[800px] flex flex-col items-center">
          ...
          <div className="text-center mb-12 w-full animate-fade-in">
            ...
            <p className="text-[#A0AAB5] text-base sm:text-lg max-w-xl mx-auto mb-8 font-normal">
              Clique no botão abaixo para baixar o arquivo ZIP completo contendo todos os craques de papel.
            </p>

            <a
              href="https://huggingface.co/datasets/luistiagos/products/resolve/main/pappercraftsoccerplayers/papercraft_soccer_players_ptbr.zip"
