        ...
        <div className="w-full max-w-[800px] flex flex-col items-center">
          ...
          <div className="text-center mb-12 w-full animate-fade-in">
            <div className="inline-block bg-[#00FF87]/10 border border-[#00FF87]/20 text-[#00FF87] px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider mb-6 animate-float-slow">
              Tabela da Copa do Mundo 2026 (Imprimível)
            </div>
            ...
            <p className="text-[#A0AAB5] text-base sm:text-lg max-w-xl mx-auto mb-8 font-normal">
              Clique no botão abaixo para baixar o arquivo ZIP contendo a Tabela de Grupos, Jogos e Resultados da Copa do Mundo 2026 (Fuso Horário BST).
            </p>
            
            <a
              href="https://huggingface.co/datasets/luistiagos/products/resolve/main/HLP%20World%20Cup%202026%20Group%2C%20Matches%20%26%20Scores%20Printable%20-%20BST%20Time%20Zone.zip"
          ...
          <div className="w-full bg-[#141C27] rounded-[24px] p-6 sm:p-10 border border-white/5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all hover:border-white/10">
            ...
            <div className="flex gap-3 mb-8 justify-center flex-wrap">
              <button
                className={`flex items-center gap-2 px-6 py-2.5 rounded-full text-sm sm:text-base font-semibold cursor-pointer transition-all border ${
                  activeTab === 'pc'
            ...
            <div className="space-y-4">
              {activeTab === 'pc' && (
                <>
                  ...
                  <div className="bg-black/20 p-5 rounded-xl border-l-4 border-[#00FF87] transition-all hover:bg-black/30 hover:translate-x-1 duration-200">
                    <p className="text-white text-[1rem] leading-relaxed">
                      4. Abra a pasta extraída. Dentro dela, você encontrará os arquivos da tabela prontos para visualização e impressão.
                    </p>
                  </div>
                </>
              )}
              ...
              {activeTab === 'mobile' && (
                <>
                  ...
                  <div className="bg-black/20 p-5 rounded-xl border-l-4 border-[#00FF87] transition-all hover:bg-black/30 hover:translate-x-1 duration-200">
                    <p className="text-white text-[1rem] leading-relaxed">
                      5. Após extrair, entre na nova pasta e toque em qualquer arquivo para visualizar e imprimir.
                    </p>
                  </div>
                </>
              )}
