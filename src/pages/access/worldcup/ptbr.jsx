        ...
        <div className="w-full max-w-[800px] flex flex-col items-center">
          ...
          <div className="text-center mb-12 w-full animate-fade-in">
            ...
            <p className="text-[#A0AAB5] text-base sm:text-lg max-w-xl mx-auto mb-8 font-normal">
              Clique no botão abaixo para baixar o arquivo ZIP completo contendo todas as suas figurinhas.
            </p>
            
            <a
              href="https://huggingface.co/datasets/luistiagos/products/resolve/main/World%20Cup%202026%20Stickers/World%20Cup%202026%20_%20Stickers_PT.zip"
